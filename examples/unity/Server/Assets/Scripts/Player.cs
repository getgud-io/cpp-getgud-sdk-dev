...
public class Player : MonoBehaviour
{
    ...
    private Message AddSpawnData(Message message)
    {
        ...
        Debug.Log($"Getgud: Player {Username} spawned with coordinates {transform.position.ToString()}");
        ...
        // Create SendSpawnActionInfo
        SendSpawnActionInfo spawnInfo = new SendSpawnActionInfo
        {
        ...
        // Send the spawn action
        int result = Methods.SendSpawnAction(spawnInfo);
